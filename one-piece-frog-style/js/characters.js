...
(function (OP) {
  ...
  const LUFFY = {
    ...
    winLine: 'Shishishi! Now let\'s eat some meat!',
    assist: 'sN',
    moves: {
      ...
      cH: M({ name: 'Rubber Uppercut', startup: 9, active: 5, recovery: 22, dmg: 70, hitstun: 26, hitstop: 10, kb: [0.8, 8.4], launch: true,
        ...
        keys: K(Object.assign({}, P.crouch, { aF1: 20, aF2: 30 }), { lean: -6, head: 10, hipH: 0.47, aF1: 168, aF2: 176, aB1: -20, aB2: 20 }, 9, 5, 22) }),
      jL: M({ name: 'Air Jab', startup: 5, active: 5, recovery: 8, dmg: 38, air: true, kb: [1.4, 1.5], box: { seg: ['elF', 'haF'], r: 0.08 },
        stretch: { limb: 'aF', len: 0.35, from: 2 },
        keys: K(null, Object.assign({}, P.jumpFall, { lean: 20, aF1: 70, aF2: 55 }), 5, 5, 8) }),
      ...
      X: M({ name: 'Gear Third: Gigant Pistol', shout: 'Gear Third! Gomu Gomu no... Gigant Pistol!', kind: 'hyper', startup: 18, active: 12, recovery: 40, dmg: 320, chip: 40, hitstun: 40, blockstun: 26, hitstop: 20,
        kb: [9, 4], knockdown: true, wallBounce: true, invuln: [0, 18], box: { seg: ['elF', 'haF'], r: 0.42 }, stretch: { limb: 'aF', len: 5.2, from: 14 }, fist: 9, sfx: 'stretch', hitSfx: 'hitH', shake: 10, don: true,
        keys: K({ lean: -18, head: -10, aF1: -80, aF2: -120, aB1: 60, aB2: 120, fB: [-0.26, 0], hipH: 0.4 }, { lean: 26, aF1: 90, aF2: 90, aB1: -40, aB2: 10, fF: [0.32, 0], fB: [-0.22, 0], hipH: 0.38 }, 18, 12, 40), expr: 'shout', cutExpr: 'puff' }),
    },
  };
  ...
  const ZORO = {
    ...
    winLine: 'Nothing happened.',
    assist: 'sU',
    moves: {
      L: M({ name: 'Ittoryu Cut', startup: 6, active: 3, recovery: 10, dmg: 45, box: { sword: 'F', r: 0.05 }, sfx: 'slash', hitSfx: 'hitSlash', spark: 'slash',
        keys: K({ aF1: 120, aF2: 160, swF: 165 }, { lean: 22, aF1: 80, aF2: 72, swF: 58 }, 6, 3, 10) }),
      H: M({ name: 'Nitoryu: Rashomon', startup: 11, active: 4, recovery: 18, dmg: 90, hitstun: 20, blockstun: 15, hitstop: 10, kb: [3.3, 0], box: { sword: 'both', r: 0.06 },
        sfx: 'slash', hitSfx: 'hitSlash', spark: 'slash', shake: 2,
        keys: K({ lean: 0, aF1: 150, aF2: 170, swF: 200, aB1: 140, aB2: 160, swB: 190 }, { lean: 28, aF1: 85, aF2: 70, swF: 40, aB1: 90, aB2: 80, swB: 55, fF: [0.28, 0], hipH: 0.38 }, 11, 4, 18) }),
      ...
      cH: M({ name: 'Rising Slash', startup: 10, active: 5, recovery: 22, dmg: 72, hitstun: 26, hitstop: 10, kb: [0.8, 8.2], launch: true, box: { sword: 'both', r: 0.06 },
        sfx: 'slash', hitSfx: 'hitSlash', spark: 'slash', shake: 2,
        keys: K(Object.assign({}, P.crouch, { aF1: 20, aF2: 10, swF: 20, aB1: 10, aB2: 0, swB: 30 }), { lean: -4, hipH: 0.47, aF1: 160, aF2: 170, swF: 175, aB1: 150, aB2: 165, swB: 190 }, 10, 5, 22) }),
      jL: M({ name: 'Air Cut', startup: 6, active: 5, recovery: 9, dmg: 42, air: true, kb: [1.4, 1.5], box: { sword: 'F', r: 0.05 }, sfx: 'slash', hitSfx: 'hitSlash', spark: 'slash',
  ...
  const SANJI = {
    ...
    quote: 'A cook never lets anyone go hungry.',
    ...
    moves: {
      ...
      jL: M({ name: 'Air Kick', startup: 5, active: 5, recovery: 8, dmg: 40, air: true, kb: [1.4, 1.5], box: { seg: ['knF', 'ftF'], r: 0.08 },
        keys: K(null, Object.assign({}, P.jumpFall, { lean: -10, lF1: 80, lF2: 70, aF1: -8, aF2: 38, aB1: -14, aB2: 30 }), 5, 5, 8) }),
      ...
      X: M({ name: 'Diable Jambe: Hell Memories', shout: 'Diable Jambe... Hell Memories!', kind: 'hyper', startup: 16, active: 4, recovery: 34, dmg: 55, chip: 8, hits: 1, hitstun: 30, blockstun: 12, hitstop: 8,
        kb: [1.6, 2.4], invuln: [0, 20], fire: true, sfx: 'fire', hitSfx: 'hitH', spark: 'fire', shake: 6, don: true,
        proj: { at: 16, kind: 'hellfire', vx: 7.5, y: 0.9, r: 0.95, len: 0.6, life: 90, hits: 6, every: 6, lastKb: [4.5, 6], lastHitstun: 50 },
  ...
  const NAMI = {
    ...
    winLine: "That'll be one hundred thousand berries!",
    assist: 'sN',
    moves: {
      ...
      cH: M({ name: 'Rising Staff', startup: 9, active: 5, recovery: 22, dmg: 68, hitstun: 26, hitstop: 10, kb: [0.8, 8.4], launch: true, box: { staff: 'full', r: 0.08 },
        sfx: 'whiffH', hitSfx: 'hitM', shake: 2,
        keys: K(Object.assign({}, P.crouch, { aF1: 20, aF2: 20, staff: 20 }), { lean: -8, hipH: 0.47, aF1: 165, aF2: 172, staff: 172 }, 9, 5, 22) }),
      jL: M({ name: 'Air Poke', startup: 5, active: 5, recovery: 8, dmg: 36, air: true, kb: [1.4, 1.5], box: { staff: 'tip', r: 0.08 },
        keys: K(null, Object.assign({}, P.jumpFall, { aF1: 70, aF2: 60, staff: 60 }), 5, 5, 8) }),
  ...
  const ROSTER = [LUFFY, ZORO, SANJI, NAMI];
  for (const c of ROSTER) {
    c.flags = c.flags || {};
    for (const k in c.moves) c.moves[k].key = k;
  }
  OP.Roster = ROSTER;
